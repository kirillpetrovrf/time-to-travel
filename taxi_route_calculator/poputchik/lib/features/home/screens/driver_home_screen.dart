    ...
    return CupertinoTabScaffold(
      ...
      tabBuilder: (context, index) {
        switch (index) {
          ...
          case 2:
            return CupertinoTabView(
              builder: (context) => const CreateRideTab(),
            );
          case 3:
            return CupertinoTabView(
              builder: (context) => ChatsTab(onChatOpened: _updateUnreadCount),
            );
          case 4:
            return CupertinoTabView(builder: (context) => const MyRidesTab());
          case 5:
            return CupertinoTabView(
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Тестовая кнопка для новой карты
                    CupertinoButton(
                      ...
                      onPressed: () {
                        Navigator.pushNamed(context, '/basic_map');
                      },
                    ),
                  ],
                ),
