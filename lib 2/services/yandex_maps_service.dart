...
/// Сервис для работы с Yandex MapKit SDK (версия 4.24.0-beta)
///
/// СТАТУС: Упрощенная версия с fallback логикой
/// TODO: Реализовать полноценную интеграцию с API 4.24.0:
...
class YandexMapsService {
  ...
  Future<Coordinates?> geocode(String address) async {
    ...
    try {
      // TODO: Обновить под новый API SearchManager из версии 4.24.0
      // Пока используем fallback координаты
      return _getMockCoordinates(address);

      // Код ниже для справки (требует обновления под новый API):
      ...
      // await resultWithSession.$1.close();
    } catch (e) {
  ...
  Future<RouteInfo?> calculateRoute(
    ...
    try {
      ...
      // TODO: Реализовать построение маршрута через DrivingRouter API 4.24.0
  ...
  Future<List<String>> getSuggestions(String query) async {
    ...
    try {
      // TODO: Реализовать через SuggestSession API 4.24.0
      // import 'package:yandex_maps_mapkit/search.dart';
      // final resultWithSession = await YandexSearch.searchByText(
      //   searchText: query,
  ...
  Coordinates? _getMockCoordinates(String address) {
    ...
    print('⚠️ [YANДEX MAPKIT] Адрес не распознан: $address');
    return null;
  }
  ...
  RouteInfo _calculateRouteByDistance(
    ...
    print('✅ [YANДEX MAPKIT] Маршрут рассчитан по прямой:');
